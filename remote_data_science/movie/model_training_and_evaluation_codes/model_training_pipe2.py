...
def main(destination_path):
    ...
    svdpp_algo,avgerror_svdpp=train_svdpp("model_training_and_evaluation_codes/data/RemappedData.csv")
    ...
    svd_algo,avgerror_svd=train_SVD_wGridSearch("model_training_and_evaluation_codes/data/RemappedData.csv")
    end_time=datetime.now()
